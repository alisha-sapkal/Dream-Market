        ...
        <div className="flex gap-6 w-max">
          <AnimatePresence>
            {offers.map((offer, idx) => (
              <motion.div
                key={offer.type}
                className="group rounded-2xl bg-white/30 text-start backdrop-blur-md shadow-lg flex flex-col items-stretch overflow-hidden sm:px-2 p-2 max-w-[320px]"
              ...
              >
                <motion.div className="relative" layout>
                  ...
                  />
                  <motion.span
                    className="absolute top-6 left-6 bg-white/30 backdrop-blur-md text-white text-xs font-semibold uppercase rounded-full px-4 py-1 shadow"
                  ...
                  >
                    <span
                      className="bg-primary text-white rounded-full px-6 py-2 font- shadow-lg hover:bg-primary-dark transition"
                ...
                >
                  ...
                  <button className="mt-auto bg-primary text-white rounded-full px-4 py-2 font-semibold hover:bg-primary-dark transition">
                    See Properties
                  </button>
                </motion.div>
              </motion.div>
