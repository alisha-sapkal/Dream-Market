    ...
    <section className="py-8 px-2 sm:px-4 md:px-8 bg-white/80 backdrop-blur rounded-2xl max-w-8xl my-8">
      ...
      >
        <div className="flex flex-col lg:flex-row items-stretch min-h-[200px]">
          <motion.div
            className="flex flex-col justify-center px-8 py-8 bg-gradient-to-r from-[#255353] to-[#51B6B6] w-full lg:w-3/5"
            initial={{ opacity: 0, x: -40 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true, amount: 0.3 }}
          ...
          >
            <motion.h3 
              className="text-2xl md:text-4xl text-white mb-4 text-left leading-tight"
